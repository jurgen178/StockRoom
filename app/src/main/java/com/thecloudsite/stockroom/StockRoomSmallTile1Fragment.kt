...
class StockRoomSmallTile1Fragment : StockRoomBaseFragment() {

  companion object {
    fun newInstance() = StockRoomSmallTile1Fragment()
  }
  ...
  override fun onViewCreated(
    ...
    val adapter = StockRoomSmallTile1Adapter(requireContext(), clickListenerSummary)
