...
import com.thecloudsite.stockroom.databinding.StockroomTile1ItemBinding
...
class StockRoomTile1Adapter internal constructor(
  ...
  class OnlineDataViewHolder(
    val binding: StockroomTile1ItemBinding
  ...
  override fun onCreateViewHolder(
    ...
    val binding = StockroomTile1ItemBinding.inflate(inflater, parent, false)
