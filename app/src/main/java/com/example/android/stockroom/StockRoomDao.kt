...
interface StockRoomDao {
    ...
    fun updateGroup(color: Int, name: String)
...
//    fun getAllAssets(): LiveData<List<Assets>> = getAllAssets1().getDistinct()
    ...
    @Transaction
    fun updateAssets(symbol: String, assets: List<Asset>) {
        deleteAssets(symbol)
