...
import io.bitfabrik.stockroom.databinding.TimelineDividendItemBinding
import io.bitfabrik.stockroom.utils.DecimalFormat2Digits
import io.bitfabrik.stockroom.utils.dividendCycleStr
import io.bitfabrik.stockroom.utils.getSymbolDisplayName
        ...
        timelineElement.dividends.sortedBy { dividend ->
            ...
            .forEach { dividend ->
                ...
                dividends += context.getString(
                    ...
                    getSymbolDisplayName(dividend.symbol)
                )
            }
