...
import io.bitfabrik.stockroom.StockMarketDataRepository.StockRawMarketDataRepository
import io.bitfabrik.stockroom.databinding.OnlinedataviewItemBinding
                ...
                if (detailViewClickCounter > 4) {
                    ...
                    runBlocking {
                        withContext(Dispatchers.IO) {
                            onlineRawJsonData =
                                stockRawMarketDataRepository.getStockRawData(stockSymbol.symbol)
                        }
                    }
                    ...
                    val htmlText =
                        HtmlCompat.fromHtml(onlineJsonData, HtmlCompat.FROM_HTML_MODE_LEGACY)
                            .toSpannable()
                    ...
                    android.app.AlertDialog.Builder(context)
                        .setTitle(
                            context.getString(
                                R.string.data_provider_details,
                                stockSymbol.symbol
                            )
                        )
                        .setMessage(htmlText)
