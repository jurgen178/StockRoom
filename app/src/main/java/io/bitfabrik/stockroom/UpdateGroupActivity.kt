...
import io.bitfabrik.stockroom.databinding.ActivityUpdategroupBinding
import io.bitfabrik.stockroom.databinding.DialogAddGroupBinding
  ...
  private fun groupItemUpdateClicked(group: GroupData) {
    ...
    builder.setView(dialogBinding.root)
      ...
      .setPositiveButton(
        ...
        // Check if color is used when a new color is chosen.
        val colorUsed = groupList.find { group ->
          group.color == color
        } != null
        if (clr != color && colorUsed) {
