...
import io.bitfabrik.stockroom.databinding.StockroomSmalllistItemBinding
...
class StockRoomSmallListAdapter internal constructor(
    ...
    override fun onBindViewHolder(
        ...
        if (current != null) {
            ...
            val changeText = assetChange.displayColorStr
            val dividendStr = getDividendStr(current, context)
            if (assetChange.displayStr.isNotEmpty() && dividendStr.isNotEmpty()) {
                changeText.append("\n")
            }
