...
import io.bitfabrik.stockroom.databinding.ActivityAddBinding
import io.bitfabrik.stockroom.list.ListActivity
...
class AddActivity : AppCompatActivity() {
    ...
    public override fun onCreate(savedInstanceState: Bundle?) {
        ...
        dataProviderSymbolsViewModelCoingecko =
            ViewModelProvider(this).get(DataProviderSymbolsViewModelCoingecko::class.java)
        ...
        dataProviderSymbolsViewModelCoingecko.symbols.observe(this, Observer { symbols ->
            ...
            binding.symbolsSpinnerCoingecko.adapter =
                ArrayAdapter(
                    ...
                    this.dataProviderSymbolsCoingecko.map { symbolEntry ->
                        symbolEntry.name
                    })
        })

        dataProviderSymbolsViewModelCoingecko.getData()
        ...
        dataProviderSymbolsViewModelCoinpaprika =
            ViewModelProvider(this).get(DataProviderSymbolsViewModelCoinpaprika::class.java)
        ...
        dataProviderSymbolsViewModelCoinpaprika.symbols.observe(this, Observer { symbols ->
            ...
            binding.symbolsSpinnerCoinpaprika.adapter =
                ArrayAdapter(
                    this,
                    layout.simple_list_item_1,
                    this.dataProviderSymbolsCoinpaprika.map { symbolEntry ->
                        symbolEntry.name
                    })
        })

        dataProviderSymbolsViewModelCoinpaprika.getData()
