...
import io.bitfabrik.stockroom.DividendCycle.Quarterly
import io.bitfabrik.stockroom.DividendType.Announced
import io.bitfabrik.stockroom.DividendType.Received
import io.bitfabrik.stockroom.MainActivity.Companion.onlineDataTimerDelay
import io.bitfabrik.stockroom.database.Assets
import io.bitfabrik.stockroom.database.Dividend
import io.bitfabrik.stockroom.database.Dividends
import io.bitfabrik.stockroom.database.StockDBdata
import io.bitfabrik.stockroom.databinding.DialogAddAccountBinding
import io.bitfabrik.stockroom.databinding.DialogAddDividendBinding
import io.bitfabrik.stockroom.databinding.DialogAddNoteBinding
import io.bitfabrik.stockroom.databinding.DialogSetAnnualDividendBinding
import io.bitfabrik.stockroom.databinding.FragmentDividendBinding
import io.bitfabrik.stockroom.utils.DecimalFormat0To2Digits
import io.bitfabrik.stockroom.utils.DecimalFormat0To6Digits
import io.bitfabrik.stockroom.utils.DecimalFormat2Digits
import io.bitfabrik.stockroom.utils.DecimalFormat2To4Digits
import io.bitfabrik.stockroom.utils.dividendCycleToSelection
import io.bitfabrik.stockroom.utils.dividendSelectionToCycle
import io.bitfabrik.stockroom.utils.getAssets
...
class DividendFragment : Fragment() {
  ...
  private fun getDividendPayout(
    ...
    if (data.assets != null) {
      val (totalQuantity, totalPrice, totalFee) = getAssets(data.assets?.assets)
