...
import io.bitfabrik.stockroom.calc.CalcActivity
import io.bitfabrik.stockroom.databinding.ActivitySettingsBinding
import io.bitfabrik.stockroom.databinding.DialogRenameAccountBinding
import io.bitfabrik.stockroom.databinding.DialogRenameSymbolBinding
import io.bitfabrik.stockroom.utils.getAppThemeColorRedGreen
import io.bitfabrik.stockroom.utils.setAppTheme
                    ...
                    OnPreferenceClickListener {
                        ...
                        builder.setView(dialogBinding.root)
                            ...
                            .setPositiveButton(R.string.rename) { _, _ ->
                                ...
                                val symbolOld =
                                    dialogBinding.textViewSymbolSpinner.selectedItem.toString()
                                ...
                                val renamed =
                                    stockRoomViewModel.renameSymbolSync(symbolOld, symbolNew)
                        ...
                        builder.setView(dialogBinding.root)
                            ...
                            .setPositiveButton(R.string.rename) { _, _ ->
                                ...
                                if (accountText.isEmpty() || accountText.compareTo(
                                    ...
                                    Toast.makeText(
                                        requireContext(),
                                        getString(R.string.account_name_not_empty),
                                        Toast.LENGTH_LONG
                                    )
                                        .show()
                                    return@setPositiveButton
                                ...
                                if (isUsed != null) {
                                    Toast.makeText(
                                        requireContext(),
                                        getString(R.string.account_name_used, accountText),
                                        Toast.LENGTH_LONG
                                    )
                                        .show()
                                    return@setPositiveButton
                                ...
                                val accountOld =
                                    dialogBinding.textViewAccountSpinner.selectedItem.toString()
